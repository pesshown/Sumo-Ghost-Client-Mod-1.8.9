...
public class KeystrokesRenderer extends Mode
{
    ...
    @Override
    public void r() {
        v((float)this.p.gx(), (float)(this.p.gy() + this.o), (float)(this.p.gx() + this.p.gw()), (float)(this.p.gy() + 15 + this.o), this.m.g3t() ? new Color(154, 2, 255).getRGB() : -12829381, this.m.g3t() ? new Color(154, 2, 255).getRGB() : -12302777);
        GL11.glPushMatrix();
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.m.g36(), (float)(this.p.gx() + this.p.gw() / 2 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.m.g36()) / 2), (float)(this.p.gy() + this.o + 4), this.m.g3t() ? -3355444 : -5592406);
        GL11.glPopMatrix();
